...
export function CurrentFoodFightCard({
  ...
  return (
    ...
    >
      ...
      {isLoading ? (
        <div
          className="space-y-4 rounded-2xl border border-border/80 bg-surface p-5 shadow-xs sm:p-6"
          role="status"
          aria-live="polite"
          aria-busy="true"
        ...
        >
          <div className="flex items-center gap-4">
            <div className="size-16 shrink-0 animate-pulse rounded-full bg-surface-subtle sm:size-[4.5rem]" />
            <div className="min-w-0 flex-1 space-y-3">
              <div className="h-5 w-3/5 animate-pulse rounded bg-surface-subtle" />
