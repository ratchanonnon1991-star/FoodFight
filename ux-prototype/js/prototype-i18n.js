...
(function () {
  ...
  const TRANSLATIONS = {
    th: {
      ...
      // FoodFight — Meal Preferences Wizard (5 Steps)
      "foodfight.pref.title": "ความต้องการมื้อนี้",
      "foodfight.pref.stepIndicator": "ขั้นตอนที่ {current} จาก {total}",
      "foodfight.pref.next": "ถัดไป →",
      "foodfight.pref.submit": "ส่งความต้องการ →",
      "foodfight.pref.additionalLabel": "เพิ่มเติม (ไม่บังคับ)",
      "foodfight.pref.additionalBudgetLabel": "งบเพิ่มเติม (ไม่บังคับ)",
      "foodfight.pref.step1Title": "ประเภทอาหาร",
      "foodfight.pref.step1Question": "วันนี้อยากกินอะไรเป็นพิเศษ?",
      "foodfight.pref.step1Subtitle": "เลือกประเภทอาหารหลักที่คุณอยากทานในมื้อนี้",
      "foodfight.pref.step1Placeholder": "เช่น พิซซ่า เบอร์เกอร์ อาหารเช้า หรือเมนูอื่นที่อยากกิน",
      "foodfight.pref.step2Title": "สัญชาติอาหาร",
      "foodfight.pref.step2Question": "อยากกินอาหารสัญชาติไหน?",
      "foodfight.pref.step2Subtitle": "เลือกสัญชาติอาหารที่ถูกใจคุณ",
      "foodfight.pref.step2Placeholder": "เช่น อินเดีย เวียดนาม อิตาเลียน เม็กซิกัน",
      "foodfight.pref.step3Title": "วัตถุดิบที่อยากกิน",
      "foodfight.pref.step3Question": "มื้อนี้อยากเน้นวัตถุดิบอะไร?",
      "foodfight.pref.step3Subtitle": "เลือกเนื้อสัตว์หรือวัตถุดิบหลักที่อยากทาน",
      "foodfight.pref.step3Placeholder": "เช่น เนื้อแกะ เป็ด เห็ด ชีส ผัก หรือวัตถุดิบอื่น",
      "foodfight.pref.step4Title": "งบประมาณต่อคน",
      "foodfight.pref.step4Question": "งบประมาณต่อคนโดยประมาณ?",
      "foodfight.pref.step4Subtitle": "เลือกระดับราคาที่สบายกระเป๋าในมื้อนี้",
      "foodfight.pref.step4Placeholder": "เช่น ไม่เกิน ฿800 ต่อคน / งบไม่จำกัด / มื้อพิเศษขอหรูหน่อย",
      "foodfight.pref.budgetTier1": "ต่ำกว่า ฿150",
      "foodfight.pref.budgetTier2": "฿150–400",
      "foodfight.pref.budgetTier3": "มากกว่า ฿400",
      "foodfight.pref.budgetTier1Label": "ประหยัด",
      "foodfight.pref.budgetTier2Label": "ปานกลาง",
      "foodfight.pref.budgetTier3Label": "พรีเมียม",
      "foodfight.pref.step5Title": "สไตล์ร้าน",
      "foodfight.pref.step5Question": "อยากได้ร้านบรรยากาศแบบไหน?",
      "foodfight.pref.step5Subtitle": "เลือกบรรยากาศหรือสไตล์ร้านที่เหมาะกับมื้อนี้",
      "foodfight.pref.step5Placeholder": "เช่น Fine Dining, Rooftop, ห้องส่วนตัว, ร้านเปิดดึก",
    ...
    en: {
      ...
      "foodfight.pref.stepIndicator": "Step {current} of {total}",
      "foodfight.pref.next": "Next →",
      "foodfight.pref.submit": "Submit Preferences →",
      "foodfight.pref.additionalLabel": "Something else? (Optional)",
      "foodfight.pref.additionalBudgetLabel": "Additional budget (Optional)",
      "foodfight.pref.step1Title": "Food Type",
      "foodfight.pref.step1Question": "What kind of food are you in the mood for?",
      "foodfight.pref.step1Subtitle": "Choose the main food types you are craving",
      "foodfight.pref.step1Placeholder": "e.g. Pizza, burgers, breakfast, or another craving",
      "foodfight.pref.step2Title": "Cuisine",
      "foodfight.pref.step2Question": "Which cuisine are you in the mood for?",
      "foodfight.pref.step2Subtitle": "Select the cuisines you'd like to eat",
      "foodfight.pref.step2Placeholder": "e.g. Indian, Vietnamese, Italian, Mexican",
      "foodfight.pref.step3Title": "Preferred Ingredients",
      "foodfight.pref.step3Question": "What ingredients are you craving?",
      "foodfight.pref.step3Subtitle": "Choose your preferred meats and key ingredients",
      "foodfight.pref.step3Placeholder": "e.g. Lamb, duck, mushrooms, cheese, vegetables, or something else",
      "foodfight.pref.step4Title": "Budget per Person",
      "foodfight.pref.step4Question": "What is your budget per person?",
      "foodfight.pref.step4Subtitle": "Select a comfortable price tier for this meal",
      "foodfight.pref.step4Placeholder": "e.g. Max ฿800 per person / No fixed budget / Special occasion",
      "foodfight.pref.budgetTier1": "< 150 THB",
      "foodfight.pref.budgetTier2": "150–400 THB",
      "foodfight.pref.budgetTier3": "400+ THB",
      "foodfight.pref.budgetTier1Label": "Budget",
      "foodfight.pref.budgetTier2Label": "Moderate",
      "foodfight.pref.budgetTier3Label": "Premium",
      "foodfight.pref.step5Title": "Restaurant Style",
      "foodfight.pref.step5Question": "What kind of place would you like?",
      "foodfight.pref.step5Subtitle": "Choose the vibe or style for this meal",
      "foodfight.pref.step5Placeholder": "e.g. Fine dining, rooftop, private room, late-night place",
