...
const receipt_ocr_service_1 = require("./receipt-ocr.service");
let OcrModule = class OcrModule {
};
exports.OcrModule = OcrModule;
exports.OcrModule = OcrModule = __decorate([
    (0, common_1.Module)({
        providers: [receipt_ocr_service_1.ReceiptOcrService],
        exports: [receipt_ocr_service_1.ReceiptOcrService],
    })
], OcrModule);
